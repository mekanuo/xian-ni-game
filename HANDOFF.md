...
root拥有Git/构建/浏览器/共享模型/QA脚本。规则、输入审查和工具代理已停写。canal_art_040现在仅独占design/MARKET_070_STATE_CONTRACT_DRAFT.md，整理生产前双向进出/承诺与履行/保存/同行草案，不改源码、不生成美术、不开浏览器。接点候选见MARKET_070_CONNECTION_REVIEW，北口接旧渠1100300/到达990350只证明局部几何，还未真实跨图。
