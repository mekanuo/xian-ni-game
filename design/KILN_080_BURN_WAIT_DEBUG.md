...
R6整轮自然烧尽已通过：134167墙钟毫秒推进11.6833模拟秒，burned保存/重入完成。随后recovery第一发ward冷却超时，15墙钟秒只推进2.8333模拟秒，原3秒还剩0.1666667；HP4MP5、paused=false。原完整FAIL归档qa/verify-080-r6。只把这段冷却观察设60秒，并新增逐发实际mana=5-n及前后timer记录，仍须冷却归零；没有手写消耗或加速游戏。恢复专项1284769正在运行，结果待核。

结合两次真实墙钟/模拟差异，对独立审查列出的1–5秒采叶/旧渠自然等待给显式余量，原谓词及手机留势安全余量不改。相关路径尚未实际复现失败，属预防同类时限风险，不能写成已修复其游戏逻辑。详见VERIFY_080_TIMING_REVIEW.md，后续完整R7验证。

恢复专项 2026-09-12T01:40:51.655Z exit0/PASS/errors空，五次真实ward各扣1MP、冷却归零后继续，观察墙钟毫秒依次 43270, 48500, 48473, 45572, 48319。最后实际控屏消耗到0MP，键盘脱困、原样导出新context恢复后点击脱困、重开完整通过；HP4保留。归档qa/kiln-recovery-green-r1。采叶/旧渠修改仍待下一整轮，不预支PASS。
