## 2026-09-11 · 0.4.1 公网核验完成

源码 ee17e8f 已推送 feat/revisit-041 与 feat/return-stone-v1；gh-pages dd82f80。public-check exit0，公开版本0.4.1，21资源哈希、桌面输入/声音、手机触控、旧档生活与旧渠入口均通过，页面错误为空。证据 qa/evidence/publication.json。原链接不变。浏览器已交给0.5真实带路检查，尚未宣称0.5可发行。

## 2026-09-11 · 0.4.1 发行验证完成

npm run verify exit0，243 项测试、17 条命令，六项运行时判据全部 PASS。真实桌面与手机走完完成后分水/复位/取水槽/归驿回访，历史与现场提示一致；qa/evidence/canal-revisit-check.json。当前包 index-COg2LfF-.js。已目视检查本轮桌面、矮窗口、手机旧渠截图；手机连续留势退岸仍余约3.1秒。即将提交、集成并发布，公网核验尚待执行。0.5 另有 316 测试通过的实现候选，尚无浏览器验收结论。
