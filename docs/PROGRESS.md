...
0.3规则、美术、严格存档迁移已完成。143项测试通过。`npm run verify` 已通过：五种视口、原主渡/山脊真实通关与重开、旧档设置导入、机械止挡双委托、留势压修与暂停存档恢复、采叶暂停/打断/重试、两份药囊驱兽、手机DPR3触控与药囊取消，页面错误为0。Linux Chrome触屏是仿真证据，Mac真机与Safari仍需用户体验反馈。部署完成后公网地址保持原入口并改为0.3.0。
