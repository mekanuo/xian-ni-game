...
async function importSave(bytes,name,{fresh=false,continuation=false}={}){
 ...
 await wait(continuation=>{const s=window.__XIAN_NI__.inspect();return s.contentVersion===4&&s.canal.stage==='complete'&&(!continuation||s.scene==='workshop'&&s.journey.stage==='active');},continuation);
