...
try{
 for(const mobile of [false,true]){
  ...
  await load('qa/evidence/life-hold-paused-input.json');if(!(await state()).paused)await tap(page.locator('.action-dock [data-ui="pause"]'));await page.waitForTimeout(200);
