...
await page.waitForFunction(()=>window.__XIAN_NI__.inspect().ended&&window.__XIAN_NI__.inspect().contentVersion===5);
...
await page.waitForFunction(()=>{const s=window.__XIAN_NI__.inspect();return s.contentVersion===5&&s.scene==='home'&&s.ended&&s.canal.stage==='unaccepted'&&s.life.repair.stage==='unaccepted';});
...
await page.waitForFunction(()=>{const s=window.__XIAN_NI__.inspect();return s.contentVersion===5&&s.canal.stage==='complete'&&s.journey.stage==='unaccepted'&&s.scene==='home';});
