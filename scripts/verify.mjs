...
try{
 ...
 for(const script of ['life-check.mjs','life-hold-check.mjs','life-mobile-check.mjs','presentation-check.mjs','canal-check.mjs','canal-view-check.mjs','canal-revisit-check.mjs','journey-check.mjs','journey-view-check.mjs','kiln-check.mjs','kiln-consequences-check.mjs','kiln-view-check.mjs']){
  const child=spawn(process.execPath,[`scripts/${script}`],{stdio:'inherit',env:{...process.env,GAME_URL:'http://127.0.0.1:4187/'}});
