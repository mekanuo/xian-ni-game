...
export const LIFE_ENTITIES: Record<SceneId, Entity[]> = {
  home:[{id:'life_home_eye',kind:'object',type:'life-eye',name:'工位固定眼',x:1030,y:500,w:30,h:36,state:'hidden'},{id:'life_practice',kind:'object',type:'life-practice',name:'挂扣试件',x:990,y:500,w:38,h:32,state:'hidden'}],
