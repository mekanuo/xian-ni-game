...
function harvestStart(origin:'tinker'|'herbalist'='tinker'){const s=finished(origin);s.player.x=1120;s.player.y=710;act(s,{type:'interact',targetId:'xu'});expect(choice(s,'life:harvest:accept').ok).toBe(true);return s;}
